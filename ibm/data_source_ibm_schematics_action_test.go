		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_schematics_action.schematics_action", "inputs.#"),
					resource.TestCheckResourceAttr("data.ibm_schematics_action.schematics_action", "inputs.0.name", actionName),
					resource.TestCheckResourceAttrSet("data.ibm_schematics_action.schematics_action", "inputs.0.value"),
					resource.TestCheckResourceAttrSet("data.ibm_schematics_action.schematics_action", "inputs.0.link"),
					resource.TestCheckResourceAttrSet("data.ibm_schematics_action.schematics_action", "outputs.#"),
					resource.TestCheckResourceAttr("data.ibm_schematics_action.schematics_action", "outputs.0.name", actionName),
					resource.TestCheckResourceAttrSet("data.ibm_schematics_action.schematics_action", "outputs.0.value"),
					resource.TestCheckResourceAttrSet("data.ibm_schematics_action.schematics_action", "outputs.0.link"),
					resource.TestCheckResourceAttrSet("data.ibm_schematics_action.schematics_action", "settings.#"),
