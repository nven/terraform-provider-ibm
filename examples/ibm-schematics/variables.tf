...
variable "schematics_workspace_template_git_folder" {
  description = "Workspace template git folder"
  type        = string
  default     = "placeholder"
}
variable "schematics_workspace_template_git_url" {
  description = "Workspace template git url"
  type        = string
  default     = "placeholder"
}
variable "schematics_workspace_template_git_branch" {
  description = "Workspace template git branch"
  type        = string
  default     = "placeholder"
}
variable "schematics_workspace_template_env_settings" {
  description = "Workspace template environment variables"
  type        = list(object({ example=string }))
  default     = [ { example: "object" } ]
}
variable "schematics_workspace_template_inputs" {
  description = "Workspace template inputs"
  type        = list(object({ example=string }))
  default     = [ { example: "object" } ]
}
...
variable "schematics_output_w_id" {
...
variable "schematics_state_w_id" {
...
variable "schematics_state_t_id" {
